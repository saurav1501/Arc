...
public class AdditionalDeatilsCreateMeterTest extends BaseClass {
	...
	public void aditioanalFieldMeterCreate(int rowNum, String loginSheet, String citySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateAdditiaonlDetailsMeterTest-CNone", "Verifies if Additional Details Create Meter functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createAdditiaonlDetailsMeterTest-CNone");
			throw e1;
		}
	}
}
