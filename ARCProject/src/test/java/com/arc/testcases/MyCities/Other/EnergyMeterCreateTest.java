...
public class EnergyMeterCreateTest extends BaseClass {
	...
	public void energyMeterCreate(int rowNum, String loginSheet, String citySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("EnergyMeterCreateTest-COther", "Verifies if Create Energy meter redaing is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("energyMeterCreateTest-COther");
			throw e1;
		}
	}
}
