...
public class VerifyRequirementsCompleteTest extends BaseClass {
	...
	public void verifyRequirementsComplete(int rowNum, String loginSheet, String citySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("RequirementComplete Test-CitiesOther", "Verifies if Requirements is complete for Precertification").assignCategory("CheckPrerequisties");
		...
		try {
			...
			CommonMethod.takeScreenshot("verifyRequirementsCompleteTest-cityOther");
			throw e1;
		}
	}
}
