...
public class EditProjectDetailsTest extends BaseClass {
	...
	public void editProjectDetails(int rowNum, String loginSheet, String citySheet) throws IOException {
		System.out.println(Thread.currentThread().getStackTrace()[1].getMethodName());
		CommonMethod.ExtentReportConfig();
		
		CommonMethod.test = CommonMethod.extent.startTest("ARC-Edit Project Details City None", "Verifies if Login functionality is working fine").assignCategory("EditMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("editProjectDetailsTest-cityNone");
			throw e1;
		}
	}
}
