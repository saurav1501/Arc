...
public class BillingDateVerificationTest extends BaseClass {
	...
	public void billingDateVerification(int rowNum, String loginSheet, String citySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("BillingDate Test-CitiesLeed", "Verifies if Billing Date is correct").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot("billingDateVerificationTest-cityLeed");
			throw e1;
		}
	}
}
