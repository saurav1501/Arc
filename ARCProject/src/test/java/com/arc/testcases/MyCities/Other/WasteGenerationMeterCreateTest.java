...
public class WasteGenerationMeterCreateTest extends BaseClass {
	...
	public void wasteGenerationMeterCreate(int rowNum, String loginSheet, String citySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateWasteGenerationMeterTest-COther", "Verifies if Login functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createWasteGenerationMeterTest-COther");
			throw e1;
		}
	}
}
