...
public class VerifyAgreementFileDownloadTest extends BaseClass {
	...
	public void verifyAgreementFileDownload(int rowNum, String loginSheet, String citySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("ARC-Verify Agreemnent File download Test City None", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot("verifyAgreementFileDownloadTest-city None");
			throw e1;
		}
	}
}
