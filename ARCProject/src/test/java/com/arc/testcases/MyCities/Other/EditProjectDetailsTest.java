...
public class EditProjectDetailsTest extends BaseClass {
	...
	public void editProjectDetails(int rowNum, String loginSheet, String citySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Edit Project Details Test Other", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot("editProjectDetailsTest-cityOther");
			throw e1;
		}
	}
}
