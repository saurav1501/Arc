...
public class WastediversionMeterCreateTest extends BaseClass {
	...
	public void wasteDiversionMeterCreate(int rowNum, String loginSheet, String citySheet, String cdataInputSheet) throws IOException {
		
		CommonMethod.ExtentReportConfig();
		System.out.println(Thread.currentThread().getStackTrace()[1].getMethodName());
		CommonMethod.test = CommonMethod.extent.startTest("CreateWasteDiversionMeterTest-CNone", "Verifies if Waste Diversion functionality is working fine").assignCategory("CretaeMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createWasteDiversionMeterTest-CNone");
			throw e1;
		}
	}
}
