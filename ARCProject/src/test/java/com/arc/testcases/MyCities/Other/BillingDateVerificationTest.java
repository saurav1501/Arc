...
public class BillingDateVerificationTest extends BaseClass {
	...
	public void billingDateVerification(int rowNum, String loginSheet, String citySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("BillingDate Test-CitiesOther", "Verifies if Billing Date is correct").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot("billingDateVerificationTest-cityOther");
			throw e1;
		}
	}
}
