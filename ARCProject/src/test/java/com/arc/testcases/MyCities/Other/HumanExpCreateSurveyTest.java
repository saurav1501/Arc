...
public class HumanExpCreateSurveyTest extends BaseClass {
	...
	public void humanExperienceMeterCreate(int rowNum, String loginSheet, String citySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateHumanExpCreateSurveyTest-COther", "Verifies if Create Human Experience Survey functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("CreateHumanExpCreateSurveyTest-COther");
			throw e1;
		}
	}
}
