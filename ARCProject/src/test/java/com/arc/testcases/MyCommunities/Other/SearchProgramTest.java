...
public class SearchProgramTest extends BaseClass {
	...
	public void searchProgram(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("SearchProgram Test-CommunitiesOther", "Verifies if Search functionality is working fine").assignCategory("CheckSearch");
		...
		try {
			...
			CommonMethod.takeScreenshot("searchProgramTest-communitiesOther");
			throw e1;
		}
	}
}
