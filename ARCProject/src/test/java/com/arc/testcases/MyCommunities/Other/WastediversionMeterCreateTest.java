...
public class WastediversionMeterCreateTest extends BaseClass {
	...
	public void wasteDiversionMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateWasteDiversionMeterTest-ComOther", "Verifies if Create Waste Diversion functionality is working fine").assignCategory("CreateMeter");
