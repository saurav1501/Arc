...
public class TrasnsportionCreateMeterTest extends BaseClass {
	...
	public void transprotionMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateTransportationMeterTest-ComNone", "Verifies if Create Transportation Meter functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createTransportationMeterTest-ComNone");
			throw e1;
		}
	}
}
