...
public class WasteGenerationMeterCreateTest extends BaseClass {
	...
	public void wasteGeneratinMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		
		CommonMethod.ExtentReportConfig();
		System.out.println(Thread.currentThread().getStackTrace()[1].getMethodName());
		CommonMethod.test = CommonMethod.extent.startTest("CreateWasteGenerationMeterTest-ComNone", "Verifies if Create Waste Generation functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createWasteMeterTest-ComNone");
			throw e1;
		}
	}
}
