...
public class TrasnsportionCreateMeterTest extends BaseClass {
	...
	public void transprotionMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateTransportationMeterTest-ComLEED", "Verifies if Create Transportation functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createTransportationMeterTest-ComLEED");
			throw e1;
		}
	}
}
