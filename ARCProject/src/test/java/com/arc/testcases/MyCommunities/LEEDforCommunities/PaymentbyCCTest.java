...
public class PaymentbyCCTest extends BaseClass {
	...
	@Test(dependsOnMethods = { "com.arc.testcases.MyCommunities.LEEDforCommunities.LoginCaseTest.loginCase","com.arc.testcases.MyCommunities.LEEDforCommunities.ClickSearchedProgramTest.clickSearchedProgram","com.arc.testcases.MyCommunities.LEEDforCommunities.AddNewProjectTest.addNewProject" })
	...
	public void paymentbyCC(int rowNum, String loginSheet, String communitySheet, String paymentSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Payment By Creditcard-CommunitiesLEED", "Verifies if Payment done through creditcard is successful").assignCategory("CheckPayment");
		...
		try {
			...
			CommonMethod.takeScreenshot("paymentbyCCTest-communitiesLEED");
			throw e1;
		}
	}
}
