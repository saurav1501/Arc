...
public class ClickSearchedProgramTest extends BaseClass {
	...
	@Test(dependsOnMethods = { "com.arc.testcases.MyCommunities.Other.LoginCaseTest.loginCase"})
	...
	public void clickSearchedProgram(int rowNum,  String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("SearchNavigation Test-CommunitiesOther", "Verifies if Search functionality is working fine").assignCategory("CheckSearch");
		...
		try {
			...
			CommonMethod.takeScreenshot("clickSearchedProgramTest-communitiesOther");
			throw e1;
		}
	}
}
