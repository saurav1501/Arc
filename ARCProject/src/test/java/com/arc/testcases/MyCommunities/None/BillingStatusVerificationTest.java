...
public class BillingStatusVerificationTest extends BaseClass {
	...
	public void billingStatusVerification(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("BillingStatus Test-CommunitiesNone", "Verifies if billing status is displaying correct in billing page").assignCategory("CheckCommunities");
		...
		try {
			...
			CommonMethod.takeScreenshot("billingStatusVerificationTest-communitiesNone");
			throw e1;
		}
	}
}
