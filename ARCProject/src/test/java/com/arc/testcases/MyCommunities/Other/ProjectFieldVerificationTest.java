...
public class ProjectFieldVerificationTest extends BaseClass {
	...
	public void projectFieldVerification(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Proejct Field Verification TestCommOther", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot("projectFieldVerificationTest-communitiesOther");
			throw e1;
		}
	}
}
