...
public class ProjectDetailsVerificationTest extends BaseClass {
	...
	public void projectDetailsVerification(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Project Details Verification Test CommNone", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot("projectDetailsVerificationTest-communitiesNone");
			throw e1;
		}
	}
}
