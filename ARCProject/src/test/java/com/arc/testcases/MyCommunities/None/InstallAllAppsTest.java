...
public class InstallAllAppsTest extends BaseClass {
	...
	public void installAllApps(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Install Apps-CommunitiesNone", "Verifies if Apps functionality is working fine").assignCategory("CheckApps");
		...
		try {
			...
			CommonMethod.takeScreenshot( "installAllAppsTest-communitiesNone");
			throw e1;
		}
	}
}
