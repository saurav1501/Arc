...
public class AdditionalDeatilsCreateMeterTest extends BaseClass {
	...
	public void aditioanalFieldMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateAdditiaonlDetailsMeterTest-ComOther", "Verifies if Create Additional Meter functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createAdditiaonlDetailsMeterTest-ComOther");
			throw e1;
		}
	}
}
