...
public class AddTeamMemberTest extends BaseClass {
	...
	@Parameters({"rowNum" ,"loginSheet","communitySheet","teamSheet"})
	public void addTeamMember(int rowNum, String loginSheet, String communitySheet, String teamSheet) throws IOException {
		System.out.println(Thread.currentThread().getStackTrace()[1].getMethodName());
		CommonMethod.ExtentReportConfig();
		
		CommonMethod.test = CommonMethod.extent.startTest("Add TeamMember Test-CommunitiesOther", "Verifies if TeamMember add functionality is working fine").assignCategory("CheckTeam");
		...
		try {
			...
			CommonMethod.takeScreenshot("addTeamMemberTest-communitiesOther");
			throw e1;
		}
	}
}
