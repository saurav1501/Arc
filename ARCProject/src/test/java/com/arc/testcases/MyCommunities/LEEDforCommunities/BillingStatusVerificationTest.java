...
public class BillingStatusVerificationTest extends BaseClass {
	...
	public void billingStatusVerification(int rowNum, String loginSheet, String communitySheet) throws IOException {
		System.out.println(Thread.currentThread().getStackTrace()[1].getMethodName());
		CommonMethod.ExtentReportConfig();
		
		CommonMethod.test = CommonMethod.extent.startTest("BillingStatus Test-LEEDCommunities", "Verifies if billing status is displaying correct in billing page").assignCategory("CheckCommunities");
		...
		try {
			...
			CommonMethod.takeScreenshot("billingStatusVerificationTest-LEEDcommunities");
			throw e1;
		}
	}
}
