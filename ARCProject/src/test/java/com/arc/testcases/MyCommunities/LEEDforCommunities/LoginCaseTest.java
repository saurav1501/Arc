...
public class LoginCaseTest extends BaseClass {
	...
	public void loginCase(int rowNum, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("Login Test-Communities LEED", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot("loginCaseTest-communitiesLEED");
			throw e1;
		}
	}
}
