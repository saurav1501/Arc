...
public class BillingDateVerificationTest extends BaseClass {
	...
	public void billingDateVerification(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("BillingDate Test-CommunitiesOther", "Verifies if Billing Date is correct").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot("billingDateVerificationTest-communitiesOther");
			throw e1;
		}
	}
}
