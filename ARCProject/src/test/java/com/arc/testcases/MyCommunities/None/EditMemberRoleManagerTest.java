...
public class EditMemberRoleManagerTest extends BaseClass {
	...
	public void editMemberRoleManager(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("EditTeamMemberRole Test-CommunitiesNone", "Verifies if edit team member functionality is working fine").assignCategory("CheckTeam");
		...
		try {
			...
			CommonMethod.takeScreenshot("editMemberRoleManagerTest-communitiesNone");
			throw e1;
		}
	}
}
