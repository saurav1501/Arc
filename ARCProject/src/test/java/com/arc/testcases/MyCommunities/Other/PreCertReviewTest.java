...
public class PreCertReviewTest extends BaseClass {
	...
	public void percertificationReview(int rowNum, String communitySheet, String paymentSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("AllSearaioPrecCertReviewTestCommOther", "Verifies  ReviewPageTest successully ").assignCategory("SubmitForReview");
		...
		try {
			...
			CommonMethod.takeScreenshot( "allSearaioPrecCertReviewTestCommOther");
			throw e1;
		}
	}
}
