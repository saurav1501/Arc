...
public class VerifyCertificationStatusTest extends BaseClass {
	...
	public void verifyCertificationStatus(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CertificationStatus Test-CommunitiesOther", "Verifies if Certification status is displayed correctly").assignCategory("CheckCertification");
		...
		try {
			...
			CommonMethod.takeScreenshot("verifyCertificationStatusTest-communitiesOther");
			throw e1;
		}
	}
}
