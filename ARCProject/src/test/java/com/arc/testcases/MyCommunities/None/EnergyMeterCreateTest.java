...
public class EnergyMeterCreateTest extends BaseClass {
	...
	public void energyMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("EnergyMeterCreateTest-ComNone", "Verifies if Create Energy Meter redaing is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("energyMeterCreateTest-ComNone");
			throw e1;
		}
	}
}
