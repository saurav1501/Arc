...
public class AdditionalDeatilsCreateMeterTest extends BaseClass {
	...
	public void aditioanalFieldMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateAdditiaonlDetailsMeterTest-ComLeed", "Verifies if Create Additional Meter functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createAdditiaonlDetailsMeterTest-ComLeed");
			throw e1;
		}
	}
}
