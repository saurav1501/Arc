...
public class VerifyRequirementsCompleteTest extends BaseClass {
	...
	@Test//(dependsOnMethods = { "com.arc.testcases.MyCommunities.LEEDforCommunities.LoginCaseTest.loginCase","com.arc.testcases.MyCommunities.LEEDforCommunities.ClickSearchedProgramTest.clickSearchedProgram","com.arc.testcases.MyCommunities.LEEDforCommunities.PaymentbyCCTest.paymentbyCC","com.arc.testcases.MyCommunities.LEEDforCommunities.PrerequisitesAttemptTest.prerequisitesAttempt" })
	...
	public void verifyRequirementsComplete(int rowNum, String loginSheet, String communitySheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("RequirementComplete Test-CommunitiesLEED", "Verifies if Requirements is complete for Precertification").assignCategory("CheckPrerequisties");
		...
		try {
			...
			CommonMethod.takeScreenshot("verifyRequirementsCompleteTest-communitiesLEED");
			throw e1;
		}
	}
}
