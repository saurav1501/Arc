...
public class WasteGenerationMeterCreateTest extends BaseClass {
	...
	public void wasteGenerationMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateWasteGenerationMeterTest-ComLEED", "Verifies if Login functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createWasteGenerationMeterTest-ComLEED");
			throw e1;
		}
	}
}
