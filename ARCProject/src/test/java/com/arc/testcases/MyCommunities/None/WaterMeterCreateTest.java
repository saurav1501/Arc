...
public class WaterMeterCreateTest extends BaseClass {
	...
	public void waterMeterCreate(int rowNum, String loginSheet, String communitySheet, String cdataInputSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("CreateWaterMeterTest-ComNone", "Verifies if Login functionality is working fine").assignCategory("CreateMeter");
		...
		try {
			...
			CommonMethod.takeScreenshot("createWaterMeterTest-ComNone");
			throw e1;
		}
	}
}
