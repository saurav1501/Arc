...
public class VerifyPRFileDownloadTest extends BaseClass {
	...
	public void VerifyPRFileDownload(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		try {
			...
			CommonMethod.takeScreenshot( "billingRegPdfdownTest-BOther");
			throw e1;
		}
	}
}
