...
public class InstallAllAppsTest extends BaseClass {
	...
	public void installAllApps(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("InstallAppsTest-BNone", "Verifies if Apps functionality is working fine").assignCategory("CheckApps");
		...
		try {
			...
			CommonMethod.takeScreenshot("InstallAppsTest-BNone");
			throw e1;
		}
	}
}
