...
public class BillingStatusVerificationTest extends BaseClass {
	...
	public void billingStatusVerificationTest(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("BillingStatusTest-BNone", "Verifies if billing status is displaying correct in billing page").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot("billingStatusTest-BNone");
			throw e1;
		}
	}
}
