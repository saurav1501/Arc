...
public class  WTotalAnalyticsTest extends BaseClass {
	...
	public void verifyWDailiyMTCO2(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("ADailiyMTCO2eTest-BOther", "Verifies Total Analytics successfully").assignCategory("CheckAnalytics");
		...
		//	reuseSearch.VerifySearchedProgram(driver, "1000137787");
			...
			CommonMethod.takeScreenshot("adailiyMTCO2eTest-BOther");
			throw e1;
		}
	}
}
