...
public class  ManageEnergyGoalTotalTest extends BaseClass {
	...
	public void goalCarbon(int rowNum, String portfoliosSheet , String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("ManageEnergyGoalTotalTest-Portfolio", "Verifies TOTAL ANNUAL CARBON EMISSIONS LEEDfortransit Successfully").assignCategory("CheckAnalytics");
		...
		//	CommonMethod.verifyLinkActive(current);
			...
			CommonMethod.takeScreenshot( "manageEnergyGoalTotalTest-Portfolio");
			throw e1;
		}
	}
}
