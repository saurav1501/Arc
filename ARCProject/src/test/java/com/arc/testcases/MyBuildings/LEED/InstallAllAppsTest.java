...
public class InstallAllAppsTest extends BaseClass {
	...
	public void installAllApps(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("InstallAppsTest-BLEED", "Verifies if Apps functionality is working fine").assignCategory("CheckApps");
		...
		try {
			...
			CommonMethod.takeScreenshot( "installAllAppsTest-buildings");
			throw e1;
		}
	}
