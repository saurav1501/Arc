...
public class BillingRegistrationAmountVerificationTest extends BaseClass {
	...
	public void billingRegistrationAmountVerification(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("ProjRegAmountTest-BNone", "Verifies if registration amount is displayed correct in billing page").assignCategory("CheckBilling");
		...
		try {
			...
			CommonMethod.takeScreenshot("projRegAmountTest-BNone");
			throw e1;
		}
	}
