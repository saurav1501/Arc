...
public class VerifyAgreementFileDownloadTest extends BaseClass {
	...
	public void verifyAgreementFileDownload(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("AgreementpdfdownloadTest-BOther", "Verifies if Login functionality is working fine").assignCategory("CheckLogin");
		...
		try {
			...
			CommonMethod.takeScreenshot( "AgreementpdfdownloadTestTest-BOther");
			throw e1;
		}
	}
}
