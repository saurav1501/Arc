...
public class AddNewProjectINDTest extends BaseClass {
	...
	public void addNewProjectTest(int rowNum, String loginSheet, String parkingSheet ) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("AddNewProjectINDTest-Parking", "Verifies if New Project is added successfully").assignCategory("CheckAddProject");
