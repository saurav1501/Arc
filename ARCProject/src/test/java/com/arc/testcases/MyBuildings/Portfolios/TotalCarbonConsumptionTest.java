...
public class  TotalCarbonConsumptionTest extends BaseClass {
	...
	public void goalCarbon(int rowNum, String portfoliosSheet , String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("TotalCarbonConsumptionAllModuleTest-Portfolio", "Verifies TOTAL ANNUAL CARBON EMISSIONS LEEDfortransit Successfully").assignCategory("CheckAnalytics");
