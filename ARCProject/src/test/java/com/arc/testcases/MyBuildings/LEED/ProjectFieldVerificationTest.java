...
public class ProjectFieldVerificationTest extends BaseClass {
	...
	public void projectFieldVerification(int rowNum, String buildingSheet, String loginSheet) throws IOException {
		...
		CommonMethod.test = CommonMethod.extent.startTest("MProjReadOnlyFieldTest-BLEED", "Verifies if Project Field is displayed correct").assignCategory("CheckProject");
		...
		//	reuseSearch.VerifySearchedProgram( "1000137695");
			...
			CommonMethod.takeScreenshot( "projectFieldVerificationTest-LEED");
			throw e1;
		}
	}
